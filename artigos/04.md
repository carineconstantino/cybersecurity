...
2. **USER32.DLL**
     ...
     1.5.SetWindowsHookEx - muito comum ver essa função em spywares e keyloggers - monitora eventos
     1.6.RegisterHotKey - define uma tecla de atalho ou um combinação de teclas
