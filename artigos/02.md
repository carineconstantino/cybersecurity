...
Outro indicador de que o arquivo é ofuscado é a pouca quantidade de funções importadas visíveis. No arquivo _malicious02.exe_ são poucas as funções importadas pelas DLL **kernel32.dll, advapi32.ddl e wininet.dll**
