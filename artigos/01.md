...
Continuando a análise, no final do arquivo são apresentadas as funções que são importadas. Ao analisar cada uma das funções é possível conhecer o comportamento do malware.  
