...
No exemplo desse artigo, eu utilizo um arquivo executável de malware do tipo Keylogger. Neste arquivo as técnicas de empacotamento e ofuscação não foram empregadas. O objetivo desse exemplo é demostrar o uso da ferramenta **Strings** em uma análise básica manual. Ferramentas para análises mais sofisticadas serão apresentadas em outros artigos. 

O ambiente de teste é uma máquina Windows 7 no virtual box. 
