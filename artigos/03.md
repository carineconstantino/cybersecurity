...
Depois que o terminal estiver disponível, o invasor inicia um ataque interno mais sofisticado. Uma das ações que podem ser executadas é a alteração do arquivo hosts para direcionar o acesso da vítima para um site específico. No exemplo abaixo, eu adiciono uma entrada DNS no arquivo hosts e sempre que a vítima for utilizar o google, sua navegação é direcionada para este artigo, por exemplo. Em um ataque real, o atacante pode enganar a vítima direcionando sua navegação para um site falso ou que mostre um alerta do tipo ransomware, exigindo que seja realizado um pagamento pois a máquina está infectada. 
